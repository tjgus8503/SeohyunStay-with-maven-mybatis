...
public interface ReservationMapper {
    ...
    @Insert("insert into reservation (id, userId, roomId, hotelId, count, checkin, checkout) " +
            "values (#{id}, #{userId}, #{roomId}, #{hotelId}, #{count}, #{checkin}, #{checkout})")
    ...
    @Select("select * from reservation where hotelId = #{hotelId}")
